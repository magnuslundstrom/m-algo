...
export const SearchOperations: React.FC<ZippedProps<SinglyLinkedList>> = ({
  ...
  return (
    <div>
      ...
      <StyledOperationButton onClick={() => curriedOperate('get', 'search')}>Get index</StyledOperationButton>
      <div style={{ display: 'flex', alignItems: 'center' }}>
        <StyledOperationInput placeholder='Index -> new Value' value={state.value} onChange={changeValue} />
        <StyledOperationButton noMarg={true} onClick={() => curriedOperate('set', 'search')}>
          Set
